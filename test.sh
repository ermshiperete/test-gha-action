...
echo "INPUT_DIST=${INPUT_DIST}, INPUT_DISTRIBUTION=${INPUT_DISTRIBUTION}, INPUT_PLATFORM=${INPUT_PLATFORM}, INPUT_ENABLE_LLSO=${INPUT_ENABLE_LLSO}, INPUT_ENABLE_PSO=${INPUT_ENABLE_PSO}"
